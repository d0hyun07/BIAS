...
def extract_features(y, sr):
    ...
    try:
        ...
        spec_contrast = librosa.feature.spectral_contrast(y=y, sr=sr) if len(y) > 4096 else np.zeros((7, 1))
...
# 📌 3️⃣ 데이터셋 로드 및 특징 추출
dataset_path = "Data/genres_original"  # 오디오 파일이 저장된 폴더
data = []
labels = []
